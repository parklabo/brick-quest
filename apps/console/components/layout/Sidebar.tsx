  ...
  return (
    <aside className="w-56 bg-slate-900 border-r border-slate-800 flex flex-col h-screen sticky top-0">
      <div className="p-5 border-b border-slate-800">
        <h1 className="text-lg font-bold text-white tracking-tight">Brick Quest</h1>
        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">Admin Console</p>
      </div>
      ...
      <div className="p-3 border-t border-slate-800">
        ...
        <p className="text-[10px] text-slate-600 px-3 mt-2">{process.env.NODE_ENV === 'development' ? 'Emulator' : 'Production'}</p>
      </div>
    </aside>
  );
}
