...
const definitions: ShapeDefinition[] = [
  ...
  },
  {
    id: 'cheese_slope',
    label: 'Cheese Slope',
    description: 'Tiny 1x1 slope at 33 degrees, plate height. Used for fine details, eyebrows, small noses, and subtle transitions.',
    category: 'slope',
    tier: 1,
    geometry: { kind: 'wedge', slopeAngleDeg: 33 },
    studs: { hasStuds: false, layout: 'none' },
    heights: { brick: 0.4, plate: 0.4, tile: 0.4 },
    geminiAliases: ['cheese_slope', 'cheese', 'small_slope', 'mini_slope', 'cheese_wedge'],
    compatibleTypes: ['slope', 'plate'],
    icon2d: { borderRadius: '1px', gradient: 'linear-gradient(150deg, rgba(255,255,255,0.6) 0%, rgba(0,0,0,0.2) 100%)' },
  },
  {
    id: 'panel',
    label: 'Panel',
    description: 'Tall flat wall panel. Used for thin vertical surfaces, side details, and flat wall elements.',
    category: 'basic',
    tier: 2,
    geometry: { kind: 'box' },
    studs: { hasStuds: true, layout: 'grid' },
    heights: { brick: 1.2, plate: 0.4, tile: 0.4 },
    geminiAliases: ['panel', 'wall_panel', 'side_panel', 'flat_panel'],
    compatibleTypes: ['brick', 'plate'],
    icon2d: { borderRadius: '1px' },
  },
  {
    id: 'plate_round',
    label: 'Round Plate',
    description: 'Flat circular plate. Used for decorative dots, eye details, and circular accents. Plate height only.',
    category: 'basic',
    tier: 1,
    geometry: { kind: 'cylinder', curveSegments: 32 },
    studs: { hasStuds: true, layout: 'single_center' },
    heights: { brick: 0.4, plate: 0.4, tile: 0.4 },
    geminiAliases: ['plate_round', 'round_plate', 'flat_round', 'dot', 'stud_plate'],
    compatibleTypes: ['plate', 'tile'],
    icon2d: { borderRadius: '50%' },
  },
